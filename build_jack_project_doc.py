...
def build():
    ...
    add_body(doc, "کنترل‌ها شامل بازاجرای قطعی فرمول امتیاز و وزن‌ها، بررسی آستانه‌ها و گردکردن عددی، تطبیق واحد ریال/تومان و نوع قیمت، کنترل تازگی و منبع، و تشخیص تعارض بین ایجنت‌ها است. ناظر هرگز داده یا امتیاز را بی‌صدا تغییر نمی‌دهد؛ خطا با شناسه، عامل مسئول و مسیر بازاجرا ثبت می‌شود.")
